...
void DrawEDOKey(int key, Vector2 pos);
...
void DrawAlgorithm(Vector2 pos, int type, bool selected);
...
void  DrawTopUI()
{
	...
	DrawText(loadedSong.songName, 45, 22 + 44, 2, 5, 0, -1, 0);
	DrawText("BY:", 45, 22 + 44, 3, 5, 0, -1, -1);
	DrawText(loadedSong.artistName, 48, 22 + 44, 3, 5, 0, -1, 6);


	// GUI Display Menu
	if (gui.uiDisplayMenuOption == 0)
		DrawText("Song", 36, 42, 2, 5, 3);
	else
		DrawText("Song", 36, 42, 2, 3, 0);
	if (gui.uiDisplayMenuOption == 1)
		DrawText("Keys", 36, 42, 3, 5, 3);
	else
		DrawText("Keys", 36, 42, 3, 3, 0);
	if (gui.uiDisplayMenuOption == 2)
		DrawText("Effect", 36, 42, 4, 5, 3);
	else
		DrawText("Effect", 36, 42, 4, 3, 0);
	if (gui.uiDisplayMenuOption == 3)
		DrawText("Voice", 36, 42, 5, 5, 3);
	else
		DrawText("Voice", 36, 42, 5, 3, 0);
	...
	{
		DrawText("V:Volume", 43, 54, 5, 3, 0);
		DrawText("P:Pitch", 43, 54, 6, 3, 0);
		DrawText("L:Low-Pass", 43, 54, 7, 3, 0);
		DrawText("H:High-Pass", 43, 54, 8, 3, 0);
		DrawText("J:Jump", 43, 54, 9, 3, 0);
		DrawText("R:Retrigger", 43, 54, 10, 3, 0);
		DrawText("M:Mute", 43, 54, 11, 3, 0);
		for (int y = 5; y < 12; y++)
			gui.activeUI[54][y].sprite = { 2, 4 };
		DrawText("S:Stereo", 55, 68, 5, 3, 0);
		DrawText("D:Delay Note", 55, 68, 6, 3, 0);
		DrawText("F:Go To Frame", 55, 68, 7, 3, 0);
		DrawText("T:Tempo", 55, 68, 8, 3, 0);
		DrawText("O:Operator V.", 55, 68, 9, 3, 0);
		DrawText("A:Arpeggio", 55, 68, 10, 3, 0);
		DrawText("C:Restart Ch.", 55, 68, 11, 3, 0);
	}
			...
			else
			{
				if (y - 2 + gui.sampleListScroll == editor.selectedSample)
				{
					if (editor.selectedButton == 8)
						DrawText(loadedSamples[y - 2 + gui.sampleListScroll].sampleName, 72, 91, y, 5, 1, -1, 8);
					else
	...
	// UI Buttons.
	DrawText("FILE", 20, 34, 8, 4, 2);
	DrawText("SETTINGS", 20, 34, 9, 4, 2);
	DrawText("HELP", 20, 34, 10, 4, 2);
	DrawText("INSTRUMENT", 20, 34, 11, 4, 2);
	for (int y = 8; y < 12; y++)
	{
		gui.activeUI[19][y].sprite = { 24, 0 };
		gui.activeUI[34][y].sprite = { 25, 0 };
	}
	/*
...
void DrawVoiceKeyboard()
{
	gui.activeUI[46][10].sprite = { 4, 17 };
	gui.activeUI[48][10].sprite = { 5, 17 };
	gui.activeUI[50][10].sprite = { 6, 17 };
	gui.activeUI[52][10].sprite = { 7, 17 };
	gui.activeUI[54][10].sprite = { 8, 17 };
	gui.activeUI[56][10].sprite = { 9, 17 };
	gui.activeUI[58][10].sprite = { 10, 17 };
	gui.activeUI[60][10].sprite = { 11, 17 };
	gui.activeUI[62][10].sprite = { 12, 17 };
	gui.activeUI[64][10].sprite = { 13, 17 };

	gui.activeUI[45][9].sprite = { 14, 17 };
	gui.activeUI[47][9].sprite = { 15, 17 };
	gui.activeUI[49][9].sprite = { 16, 17 };
	gui.activeUI[51][9].sprite = { 17, 17 };
	gui.activeUI[53][9].sprite = { 18, 17 };
	gui.activeUI[55][9].sprite = { 19, 17 };
	gui.activeUI[57][9].sprite = { 20, 17 };
	gui.activeUI[59][9].sprite = { 21, 17 };
	gui.activeUI[61][9].sprite = { 22, 17 };
	gui.activeUI[63][9].sprite = { 23, 17 };
	gui.activeUI[65][9].sprite = { 24, 17 };

	gui.activeUI[44][8].sprite = { 25, 17 };
	gui.activeUI[46][8].sprite = { 4, 18 };
	gui.activeUI[48][8].sprite = { 5, 18 };
	gui.activeUI[50][8].sprite = { 6, 18 };
	gui.activeUI[52][8].sprite = { 7, 18 };
	gui.activeUI[54][8].sprite = { 8, 18 };
	gui.activeUI[56][8].sprite = { 9, 18 };
	gui.activeUI[58][8].sprite = { 10, 18 };
	gui.activeUI[60][8].sprite = { 11, 18 };
	gui.activeUI[62][8].sprite = { 12, 18 };
	gui.activeUI[64][8].sprite = { 13, 18 };
	gui.activeUI[66][8].sprite = { 14, 18 };

	gui.activeUI[43][7].sprite = { 15, 18 };
	gui.activeUI[45][7].sprite = { 16, 18 };
	gui.activeUI[47][7].sprite = { 17, 18 };
	gui.activeUI[49][7].sprite = { 18, 18 };
	gui.activeUI[51][7].sprite = { 19, 18 };
	gui.activeUI[53][7].sprite = { 20, 18 };
	gui.activeUI[55][7].sprite = { 21, 18 };
	gui.activeUI[57][7].sprite = { 22, 18 };
	gui.activeUI[59][7].sprite = { 23, 18 };
	gui.activeUI[61][7].sprite = { 24, 18 };
	gui.activeUI[63][7].sprite = { 25, 18 };
	//gui.activeUI[65][7].sprite = { 26, 18 };
...
void DrawMute()
{
	...
	// Count modulator channels and adjust the number of knobs accordingly.
	//gui.knobs.resize(modCount + 4);
...
void DrawBackground(float startPos)
{
	...
	for (int x = startPos; x < 92; x++)
	{
		...
		for (int y = 16; y < 40; y++)
		{
			...
			else if (y + star * 4 > 30)
			{
				...
				else
				{
					...
					if (y + star * 4 > 50)
						star += 4;
					gui.activeUI[x][y].sprite = { float(16 + star), 21 };
				}
			}
		...
		for (int y = 32; y < 56; y++)
		{
			gui.activeUI[x][y].sprite = { float(16 + y - 36), 22 };
		}
	}
	...
	for (int x = startPos; x < 92; x++)
	{
		...
		gui.activeUI[x][57 - yVal].sprite = { float(mountTexX), float(mountTexY) };
	...
	for (int x = startPos; x < 92; x++)
	{
		...
		for (int y = 58 - yVal; y < 56; y++)
		{
			...
			gui.activeUI[x][y].sprite = { float(mountTexX), float(mountTexY) };
		}
	}
...
void DrawChannelLineValues(int channelNum, int offsetX, int y)
{
	...
	if (y + intScrollY < loadedFrame.rows.size())
	{
		if (loadedFrame.rows[y + intScrollY].note[channelNum] == 255) // Stop Note
		{
			...
			{
				if (xOffset > 4 && xOffset < 91)
					gui.activeUI[xOffset][y + 16].sprite = { 21 + float(i), 3 };
				xOffset++;
			}
		}
		else
		...
		for (int ef = 0; ef < channels[channelNum].effectCountPerRow; ef++)
		{
			...
			if (loadedFrame.rows[y + intScrollY].effects[channelNum].cEffect[ef] > -1) // Effect
			{
				...
				else
				{
					if (xOffset > 4 && xOffset < 91)
					{
						gui.activeUI[xOffset][y + 16].sprite = { float(effectNum), 1 };
						gui.activeUI[xOffset][y + 16].textCol = textColor;
					}
					xOffset++;
					if (xOffset > 4 && xOffset < 91)
...
void DrawEDONote(uint8_t num, int textStart, int textY, int textCol, int bgCol, int selectedLetter, int buttonIndex)
{
	...
	if (textStart < 90)
	{
		if (betweenNotes < 0.25f)
			gui.activeUI[textStart + 1][textY].sprite = { 0, 17 + float(sharped) };
		else if (betweenNotes < 0.5f)
			gui.activeUI[textStart + 1][textY].sprite = { 1, 17 + float(sharped) };
		else if (betweenNotes < 0.75f)
			gui.activeUI[textStart + 1][textY].sprite = { 2, 17 + float(sharped) };
		else
			gui.activeUI[textStart + 1][textY].sprite = { 3, 17 + float(sharped) };
	}
...
void DrawKey(int button, int key, Vector2 pos)
{
	...
	{
		gui.activeUI[int(pos.x)][int(pos.y)].textCol = 5;
		gui.activeUI[int(pos.x)][int(pos.y)].bgCol = 16;
		gui.activeUI[int(pos.x + 1)][int(pos.y)].textCol = 5;
		gui.activeUI[int(pos.x + 1)][int(pos.y)].bgCol = 16;
	}
	else
	{
...
void DrawEDOKey(int key, Vector2 pos)
{
	...
	{
		gui.activeUI[int(pos.x)][int(pos.y)].bgCol = 3;
		gui.activeUI[int(pos.x)][int(pos.y)].textCol = 5;
		gui.activeUI[int(pos.x + 1)][int(pos.y)].bgCol = 3;
		gui.activeUI[int(pos.x + 1)][int(pos.y)].textCol = 5;
	}
	else
	{
		gui.activeUI[int(pos.x)][int(pos.y)].bgCol = 1;
		gui.activeUI[int(pos.x)][int(pos.y)].textCol = 3;
		gui.activeUI[int(pos.x + 1)][int(pos.y)].bgCol = 1;
		gui.activeUI[int(pos.x + 1)][int(pos.y)].textCol = 3;
	}
	...
	gui.activeUI[int(pos.x)][int(pos.y)].sprite = { float(scaleLetter), 16 };
	if (betweenNotes < 0.25f)
		gui.activeUI[int(pos.x + 1)][int(pos.y)].sprite = { 0, 17 + float(sharped) };
	else if (betweenNotes < 0.5f)
		gui.activeUI[int(pos.x + 1)][int(pos.y)].sprite = { 1, 17 + float(sharped) };
	else if (betweenNotes < 0.75f)
		gui.activeUI[int(pos.x + 1)][int(pos.y)].sprite = { 2, 17 + float(sharped) };
	else
		gui.activeUI[int(pos.x + 1)][int(pos.y)].sprite = { 3, 17 + float(sharped) };
...
void DrawFloatingWindow(FloatingWindow* wind)
{
	...
	if (wind->name == "Themes")
	{
		std::string themeText[32] = {
			...
			"Log Cabin", "Mahogany", "Rust", "Bright Sand",
			"Sand", "Gold", "Burnt", "Bone White",
			"Neutral Grey","Blue-Green", "Olive", "Toxic",
			"Lichen", "Forest", "Emerald", "Blue-Gold",
			"Lotis", "Sea Foam", "Nautical", "Silver",
			"Lunar", "Blue Glass", "Standard", "Plasic",
			"Deep Sea", "Bright Pink", "Cosmic", "Amythest",
		};
		...
		for (int i = 0; i < 32; i++)
		{
			DrawText(themeText[i], wind->position.x + 2, wind->position.x + 15, wind->position.y + 1 + i, 4, 2);
			...
			{
				gui.activeUI[int(wind->position.x + 1)][int(wind->position.y + 1 + i)].sprite = { 24, 0 };
				gui.activeUI[int(wind->position.x + 15)][int(wind->position.y + 1 + i)].sprite = { 25, 0 };
			}
		}
	}
	...
	else if (wind->name == "Transpose")
	{
		...
		DrawEDONote(editor.transposeValue + 48, wind->position.x + 9, wind->position.y + 7, 4, 1, -1, -1);
	...
	else if (wind->name == "Instrument Editor")
	{
		...
		sampleDisplay.position.y = wind->position.y + 31.5f;


		// Sample name
		DrawText("INSTRUMENT NAME: ", wind->position.x + 1, wind->position.x + 17, wind->position.y + 1, 3, 1);
		if (!loadedSamples[editor.selectedSample].enabled)
			DrawText("NO SAMPLE LOADED", wind->position.x + 17, wind->position.x + 34, wind->position.y + 1, 3, 1);
		else
			DrawText(loadedSamples[editor.selectedSample].sampleName, wind->position.x + 14, wind->position.x + 34, wind->position.y + 1, 3, 1);

		// Volume/Arp speed
		if (sampleDisplay.displayArp)
		{
			DrawText("Speed:", wind->position.x + 18, wind->position.x + 25, wind->position.y + 2, 3, 0);
			DrawHorizontalSlider(int(wind->position.x + 25), int(wind->position.y + 2), loadedSamples[editor.selectedSample].arpSpeed);
		}
		else
		{
			DrawText("Volume:", wind->position.x + 18, wind->position.x + 25, wind->position.y + 2, 3, 0);
			DrawHorizontalSlider(int(wind->position.x + 25), int(wind->position.y + 2), loadedSamples[editor.selectedSample].volume);
		}

		// waveform or sample.
		gui.activeUI[int(wind->position.x + 2)][int(wind->position.y + 2)].sprite = { 24, 0 };
		if (loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].waveform)
			DrawText("Waveform", wind->position.x + 3, wind->position.x + 12, wind->position.y + 2, 4, 2);
		else
			DrawText("Sample", wind->position.x + 3, wind->position.x + 12, wind->position.y + 2, 4, 2);
		gui.activeUI[int(wind->position.x + 12)][int(wind->position.y + 2)].sprite = { 25, 0 };
		...
		if (loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].waveform)
		{
			if (loadedSamples[editor.selectedSample].enabled)
			{
				DrawText("SHAPE", wind->position.x + 3, wind->position.x + 12, wind->position.y + 3, 3, 0);
				...
				// Reverse wave toggle.
				DrawText("Reverse:", wind->position.x + 1, wind->position.x + 10, wind->position.y + 11, 3, 0);
				...
				// Offset
				DrawText("Offset:", wind->position.x + 1, wind->position.x + 10, wind->position.y + 16, 3, 0);
		...
		for (int x = 0; x < 15; x++)
		{
			...
			else if (loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].waveform)
			{
				float offsetSprite = 0;
				...
				for (int y = 0; y < 14; y++)
				{
					if (y < loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].frequencies[x])
					{
						if (loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].frequencies[x] - y == 0.25)
							gui.activeUI[int(wind->position.x + 18 + x)][int(wind->position.y + 16 - y)].sprite = { 7, 20 + offsetSprite };
						else if (loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].frequencies[x] - y == 0.5)
							gui.activeUI[int(wind->position.x + 18 + x)][int(wind->position.y + 16 - y)].sprite = { 8, 20 + offsetSprite };
						else if (loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].frequencies[x] - y == 0.75)
		...
		if (loadedSamples[editor.selectedSample].enabled && !loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].waveform)
		{
		...
		if (loadedSamples[editor.selectedSample].enabled)
		{
			...
			gui.activeUI[int(wind->position.x + 6)][int(wind->position.y + 38)].sprite = { 24, 0 };
			if (sampleDisplay.measurementSystem == 0)
				DrawText("Frames:" + std::to_string(loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].pcmFrames.size()), wind->position.x + 7, wind->position.x + 24, wind->position.y + 38, 4, 2);
			else if (sampleDisplay.measurementSystem == 1)
			{
				float milis = (float(loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].pcmFrames.size()) / 48000.0f) * 1000.0f;
				DrawText("MS:" + std::to_string(milis), wind->position.x + 7, wind->position.x + 24, wind->position.y + 38, 4, 2);
			}
			else
			{
				float seconds = (float(loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].pcmFrames.size()) / 48000.0f);
				DrawText("Seconds:" + std::to_string(seconds), wind->position.x + 7, wind->position.x + 24, wind->position.y + 38, 4, 2);
			}
				
			gui.activeUI[int(wind->position.x + 24)][int(wind->position.y + 38)].sprite = { 25, 0 };


			// Loop button
			DrawText("LOOP", wind->position.x + 3, wind->position.x + 7, wind->position.y + 8, 3, 0);
			gui.activeUI[int(wind->position.x + 2)][int(wind->position.y + 9)].sprite = { 24, 0 };
			if (loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].loopType == 0)
				DrawText("None", wind->position.x + 3, wind->position.x + 12, wind->position.y + 9, 4, 2);
			else if (loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].loopType == 1)
				DrawText("Forwards", wind->position.x + 3, wind->position.x + 12, wind->position.y + 9, 4, 2);
			else
				DrawText("Bounce", wind->position.x + 3, wind->position.x + 12, wind->position.y + 9, 4, 2);
			gui.activeUI[int(wind->position.x + 12)][int(wind->position.y + 9)].sprite = { 25, 0 };


			// Snap button
			DrawText("Snap:" + std::to_string(sampleDisplay.snapSubdivisions), wind->position.x + 1, wind->position.x + 9, wind->position.y + 10, 3, 0);
			...
			// ASDR
			DrawText("Attack:", wind->position.x + 1, wind->position.x + 10, wind->position.y + 12, 3, 0);
			...
			DrawText("Sustain:", wind->position.x + 1, wind->position.x + 10, wind->position.y + 13, 3, 0);
			...
			DrawText("Decay:", wind->position.x + 1, wind->position.x + 10, wind->position.y + 14, 3, 0);
			...
			DrawText("Release:", wind->position.x + 1, wind->position.x + 10, wind->position.y + 15, 3, 0);
			...
			// Glide
			DrawText("Glide:", wind->position.x + 1, wind->position.x + 10, wind->position.y + 17, 3, 0);
			DrawHorizontalSlider(int(wind->position.x + 9), int(wind->position.y + 17), loadedSamples[editor.selectedSample].glide);
			// Pitch to note
			DrawText("Pitch to Note:", wind->position.x + 1, wind->position.x + 16, wind->position.y + 19, 3, 0);
			...
			// LFO
			DrawText("Use as LFO:", wind->position.x + 1, wind->position.x + 16, wind->position.y + 20, 3, 0);
			gui.activeUI[int(wind->position.x + 13)][int(wind->position.y + 20)].sprite = { 24, 0 };
			DrawText(std::to_string(int(loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].lfo)), wind->position.x + 14, wind->position.x + 16, wind->position.y + 20, 5, 2);
			gui.activeUI[int(wind->position.x + 16)][int(wind->position.y + 20)].sprite = { 25, 0 };
			// Continue note
			DrawText("Continue Note:", wind->position.x + 1, wind->position.x + 16, wind->position.y + 21, 3, 0);
			...
			{
				gui.activeUI[int(wind->position.x + 2)][int(wind->position.y + 22 + mod)].sprite = { 24, 0 };
				DrawText("Mod" + std::to_string(mod + 1), wind->position.x + 13, wind->position.x + 17, wind->position.y + 22 + mod, 3, 0);
				if (loadedSamples[editor.selectedSample].modulationTypes[mod] == 0)
					DrawText("FM", wind->position.x + 3, wind->position.x + 12, wind->position.y + 22 + mod, 4, 2);
				else if (loadedSamples[editor.selectedSample].modulationTypes[mod] == 1)
					DrawText("AM", wind->position.x + 3, wind->position.x + 12, wind->position.y + 22 + mod, 4, 2);
				else if (loadedSamples[editor.selectedSample].modulationTypes[mod] == 2)
					DrawText("Delay", wind->position.x + 3, wind->position.x + 12, wind->position.y + 22 + mod, 4, 2);
				else
				{
					DrawText("Low-Pass", wind->position.x + 3, wind->position.x + 12, wind->position.y + 22 + mod, 4, 2);
					DrawHorizontalSlider(int(wind->position.x + 13), wind->position.y + 22 + mod, loadedSamples[editor.selectedSample].lPResonances[mod]);
				}
				gui.activeUI[int(wind->position.x + 12)][int(wind->position.y + 22 + mod)].sprite = { 25, 0 };
				

				// Frequency/arp toggle button.
				gui.activeUI[int(wind->position.x + 18)][int(wind->position.y + 17)].sprite = { 24, 0 };
				if (sampleDisplay.displayArp)
					DrawText("Arpeggio", wind->position.x + 19, wind->position.x + 32, wind->position.y + 17, 4, 2);
				else
					DrawText("Frequencies", wind->position.x + 19, wind->position.x + 32, wind->position.y + 17, 4, 2);
				gui.activeUI[int(wind->position.x + 32)][int(wind->position.y + 17)].sprite = { 25, 0 };
			}
			...
			gui.activeUI[int(wind->position.x + 22)][int(wind->position.y + 23)].sprite = { 24, 0 };
			DrawText("Swap Oper.", wind->position.x + 23, wind->position.x + 33, wind->position.y + 23, 4, 2);
			gui.activeUI[int(wind->position.x + 33)][int(wind->position.y + 23)].sprite = { 25, 0 };

			gui.activeUI[int(wind->position.x + 22)][int(wind->position.y + 24)].sprite = { 24, 0 };
			DrawText("Algorithms", wind->position.x + 23, wind->position.x + 33, wind->position.y + 24, 4, 2);
			gui.activeUI[int(wind->position.x + 33)][int(wind->position.y + 24)].sprite = { 25, 0 };
		}

		gui.activeUI[int(wind->position.x + 22)][int(wind->position.y + 25)].sprite = { 24, 0 };
		DrawText("Presets", wind->position.x + 23, wind->position.x + 33, wind->position.y + 25, 4, 2);
		gui.activeUI[int(wind->position.x + 33)][int(wind->position.y + 25)].sprite = { 25, 0 };
	...
	{
		DrawText("Fine-tune", wind->position.x + 2, wind->position.x + 12, wind->position.y + 2, 4, 0);
		gui.activeUI[int(wind->position.x + 2)][int(wind->position.y + 3)].sprite = { 8, 3 };
		gui.activeUI[int(wind->position.x + 3)][int(wind->position.y + 3)].sprite = { 9, 3 };
		gui.activeUI[int(wind->position.x + 4)][int(wind->position.y + 3)].sprite = { 10, 3 };
		DrawText(std::to_string(sampleDisplay.resampleFineTune), wind->position.x + 6, wind->position.x + 16, wind->position.y + 3, 4, 0);
		DrawText("Semitones", wind->position.x + 2, wind->position.x + 12, wind->position.y + 4, 4, 1);
		gui.activeUI[int(wind->position.x + 2)][int(wind->position.y + 5)].sprite = { 8, 3 };
		gui.activeUI[int(wind->position.x + 3)][int(wind->position.y + 5)].sprite = { 9, 3 };
		gui.activeUI[int(wind->position.x + 4)][int(wind->position.y + 5)].sprite = { 10, 3 };
		DrawText("C-4 to ", wind->position.x + 6, wind->position.x + 13, wind->position.y + 5, 4, 1);
		DrawEDONote(sampleDisplay.resampleNote, wind->position.x + 13, wind->position.y + 5, 4, 1, -1, -1);
		
		float selectedFrameSize = abs(sampleDisplay.sampleSelectionEnd - sampleDisplay.sampleStartPos);
		DrawText(std::to_string(int(selectedFrameSize)) + " frames", wind->position.x + 2, wind->position.x + 20, wind->position.y + 7, 4, 0);
		DrawText("to ", wind->position.x + 2, wind->position.x + 20, wind->position.y + 8, 4, 0);
		...
		DrawText("APPLY", wind->position.x + 9, wind->position.x + 14, wind->position.y + 11, 4, 2);
		gui.activeUI[int(wind->position.x + 8)][int(wind->position.y + 11)].sprite = { 24, 0 };
		gui.activeUI[int(wind->position.x + 14)][int(wind->position.y + 11)].sprite = { 25, 0 };
	}
	else if (wind->name == "Sample Volume")
	{
		DrawText("Volume", wind->position.x + 2, wind->position.x + 12, wind->position.y + 2, 4, 1);
		gui.activeUI[int(wind->position.x + 2)][int(wind->position.y + 3)].sprite = { 8, 3 };
		gui.activeUI[int(wind->position.x + 3)][int(wind->position.y + 3)].sprite = { 9, 3 };
		gui.activeUI[int(wind->position.x + 4)][int(wind->position.y + 3)].sprite = { 10, 3 };
		DrawText(std::to_string(sampleDisplay.volumeMultiplier), wind->position.x + 6, wind->position.x + 16, wind->position.y + 3, 4, 1);

		DrawText("APPLY", wind->position.x + 9, wind->position.x + 14, wind->position.y + 5, 4, 2);
		gui.activeUI[int(wind->position.x + 8)][int(wind->position.y + 5)].sprite = { 24, 0 };
		gui.activeUI[int(wind->position.x + 14)][int(wind->position.y + 5)].sprite = { 25, 0 };
	}
	else if (wind->name == "Editors")
	{
		std::string settingsText[3] = {
			"Samples", "Instruments", "Mixer"
		};
		for (int i = 0; i < 3; i++)
		{
			DrawText(settingsText[i], wind->position.x + 2, wind->position.x + 15, wind->position.y + 2 + i * 2, 4, 2);
	...
	else if (wind->name == "Algorithms")
	{
		...
		DrawText("APPLY", wind->position.x + 9, wind->position.x + 14, wind->position.y + 32, 4, 2);
		gui.activeUI[int(wind->position.x + 8)][int(wind->position.y + 32)].sprite = { 24, 0 };
		gui.activeUI[int(wind->position.x + 14)][int(wind->position.y + 32)].sprite = { 25, 0 };
	}
	else if (wind->name == "Presets")
	{
		for (int i = 0; i < 6; i++)
		{
			gui.activeUI[int(wind->position.x + 1)][int(wind->position.y + 2 * i + 1)].sprite = { 24, 0 };
			gui.activeUI[int(wind->position.x + 12)][int(wind->position.y + 2 * i + 1)].sprite = { 25, 0 };
		}
		DrawText("LEADS", wind->position.x + 2, wind->position.x + 12, wind->position.y + 1, 4, 1);
		DrawText("PADS", wind->position.x + 2, wind->position.x + 12, wind->position.y + 3, 4, 1);
		DrawText("BASS", wind->position.x + 2, wind->position.x + 12, wind->position.y + 5, 4, 1);
		DrawText("KEYS", wind->position.x + 2, wind->position.x + 12, wind->position.y + 7, 4, 1);
		DrawText("PERCUSSION", wind->position.x + 2, wind->position.x + 12, wind->position.y + 9, 4, 1);
		DrawText("SFX", wind->position.x + 2, wind->position.x + 12, wind->position.y + 11, 4, 1);

		for (int x = 1; x < 14; x++)
		{
			gui.activeUI[int(wind->position.x + x)][int(wind->position.y + 2 * presetMenu.instrumentType + 1)].bgCol = 3;
			gui.activeUI[int(wind->position.x + x)][int(wind->position.y + 2 * presetMenu.instrumentType + 1)].textCol = 5;
		}
		...
		for (int i = 0; i < 16; i++)
		{
			...
			if (i == presetMenu.selectedSample)
				DrawText(presetMenu.presetNames[presetMenu.instrumentType * 32 + i], wind->position.x + 14, wind->position.x + 30, wind->position.y + i + 1, 5, 2);
			else
				DrawText(presetMenu.presetNames[presetMenu.instrumentType * 32 + i], wind->position.x + 14, wind->position.x + 30, wind->position.y + i + 1, 3, 0);
			if (i + 16 == presetMenu.selectedSample)
				DrawText(presetMenu.presetNames[presetMenu.instrumentType * 32 + i + 16], wind->position.x + 31, wind->position.x + 48, wind->position.y + i + 1, 5, 2);
			else
				DrawText(presetMenu.presetNames[presetMenu.instrumentType * 32 + i + 16], wind->position.x + 31, wind->position.x + 48, wind->position.y + i + 1, 3, 0);
		}

		gui.activeUI[int(wind->position.x + 8)][int(wind->position.y + 17)].sprite = { 24, 0 };
		DrawText("APPLY", wind->position.x + 9, wind->position.x + 14, wind->position.y + 17, 4, 2);
		gui.activeUI[int(wind->position.x + 14)][int(wind->position.y + 17)].sprite = { 25, 0 };
	}
	else if (wind->name == "Algorithms")
	{
		for (int x = 0; x < 4; x++)
	...
	else if (wind->name == "Swap Oper.")
	{
		for (int i = 0; i < 4; i++)
		{
			gui.activeUI[int(wind->position.x + i * 2 + 2)][int(wind->position.y + 2)].sprite = { float(i), 7 };
			gui.activeUI[int(wind->position.x + i * 2 + 2)][int(wind->position.y + 3)].sprite = { 5, 24 };
			gui.activeUI[int(wind->position.x + i * 2 + 2)][int(wind->position.y + 4)].sprite = { float(sampleDisplay.swapMenuOperators[i]), 7 };
		}

		gui.activeUI[int(wind->position.x + 8)][int(wind->position.y + 6)].sprite = { 24, 0 };
		DrawText("APPLY", wind->position.x + 9, wind->position.x + 14, wind->position.y + 6, 4, 2);
		gui.activeUI[int(wind->position.x + 14)][int(wind->position.y + 6)].sprite = { 25, 0 };
	}
	...
	else if (wind->name == "Phonemes")
	{
		for (int y = 0; y < 22; y++)
		{
			gui.activeUI[int(wind->position.x + 1)][int(wind->position.y + 2 + y)].sprite = { 4 + float(y), 17 };

			gui.activeUI[int(wind->position.x + 2)][int(wind->position.y + 2 + y)].sprite = { 24, 0 };
			DrawText("Set", wind->position.x + 3, wind->position.x + 6, wind->position.y + 2 + y, 4, 2);
			gui.activeUI[int(wind->position.x + 6)][int(wind->position.y + 2 + y)].sprite = { 25, 0 };

			gui.activeUI[int(wind->position.x + 8)][int(wind->position.y + 2 + y)].sprite = { 24, 0 };
			DrawText("Set", wind->position.x + 9, wind->position.x + 12, wind->position.y + 2 + y, 4, 2);
			gui.activeUI[int(wind->position.x + 12)][int(wind->position.y + 2 + y)].sprite = { 25, 0 };

			gui.activeUI[int(wind->position.x + 13)][int(wind->position.y + 2 + y)].sprite = { 4 + float(y), 18 };
		}

		gui.activeUI[int(wind->position.x + 1)][int(wind->position.y + 25)].sprite = { 24, 0 };
		DrawText("SAVE", wind->position.x + 2, wind->position.x + 6, wind->position.y + 25, 4, 2);
		gui.activeUI[int(wind->position.x + 6)][int(wind->position.y + 25)].sprite = { 25, 0 };
	}
...
void DrawWaveTypeButton(int type, int xVal, int yVal)
{
	...
	switch (type)
	{
		...
		case 5:
		{
			DrawText("BELL", xVal, xVal + 9, yVal, 4, 2);
			break;
		}

		case 6:
		{
			DrawText("ORGAN", xVal, xVal + 9, yVal, 4, 2);
			break;
		}
	...
	if (loadedSamples[editor.selectedSample].enabled)
	{
		...
		{
			DrawText("Duty:" + std::to_string(int(loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].dutyCycle * 100)), xVal - 2, xVal + 8, yVal + 1, 3, 0);
		...
		if (type > 3) // Bell
		{
			DrawText("Waves:" + std::to_string(int(loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].numOfSineWaves)), xVal - 2, xVal + 8, yVal + 2, 3, 0);
		...
		else if (type > 0 && type != 2) // There is no smoothness effect for: sine, triangle, noise.
		{
			...
			{
				DrawText("Waves:" + std::to_string(int(loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].numOfSineWaves)), xVal - 2, xVal + 8, yVal + 2, 3, 0);
				DrawText("FROM SINE", xVal, xVal + 9, yVal + 3, 4, 2);

				DrawHorizontalSlider(int(xVal + 6), int(yVal + 2), float(loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].numOfSineWaves) / 16.0f);
			}
			else
			{
				DrawText("Soft:" + std::to_string(int(loadedSamples[editor.selectedSample].waveforms[sampleDisplay.selectedOperator].smoothness * 100)), xVal - 2, xVal + 8, yVal + 2, 3, 0);
				DrawText("EXACT", xVal, xVal + 9, yVal + 3, 4, 2);
			...
			gui.activeUI[int(xVal - 1)][int(yVal + 3)].sprite = { 24, 0 };
			gui.activeUI[int(xVal + 9)][int(yVal + 3)].sprite = { 25, 0 };
		}
	}
...
void DrawEffect(Vector2 pos, int type, int value)
{
	...
	case 0: case 1: case 2: case 3: case 4: case 5: case 6: case 7:
	{
		...
		gui.activeUI[int(pos.x)][int(pos.y)].sprite = { 9, float(24 + type) };
		gui.activeUI[int(pos.x + 1)][int(pos.y)].sprite = { 10, float(24 + type) };
		float val1 = value % 10;
		float val10 = (value - val1) / 10;
		if (val10 == 0)
	...
	case 8: case 9:
	{
		...
		gui.activeUI[int(pos.x)][int(pos.y)].sprite = { 11, float(15 + type) };
		gui.activeUI[int(pos.x + 1)][int(pos.y)].sprite = { 12, float(15 + type) };
		if (value == 0)
	...
	case 14:
	{
		gui.activeUI[int(pos.x)][int(pos.y)].sprite = { 11, float(15 + type) };
		float val1 = value % 10;
		float val10 = (value % 100) - val1;
		float val100 = value - val10 - val1;
...
void DrawAlgorithm(Vector2 pos, int type, bool selected)
{
	for (int x = 0; x < 7; x++)
	{
		for (int y = 0; y < 5; y++)
		{
			gui.activeUI[int(pos.x + x)][int(pos.y + y)].sprite = { 4, 7 };
		}
	}
	...
	if (selected)
	{
		for (int x = 0; x < 7; x++)
		{
			for (int y = 0; y < 5; y++)
			{
				gui.activeUI[int(pos.x + x)][int(pos.y + y)].bgCol = 1;
				gui.activeUI[int(pos.x + x)][int(pos.y + y)].textCol = 2;
			}
		}
	}
	else
	{
		for (int x = 0; x < 7; x++)
		{
			for (int y = 0; y < 5; y++)
			{
				gui.activeUI[int(pos.x + x)][int(pos.y + y)].bgCol = 0;
				gui.activeUI[int(pos.x + x)][int(pos.y + y)].textCol = 1;
			}
		}
	}
	...
	case 0:
	{
		gui.activeUI[int(pos.x + 3)][int(pos.y + 3)].sprite = { 0, 7 };
	...
	case 1:
	{
		gui.activeUI[int(pos.x + 2)][int(pos.y + 3)].sprite = { 0, 7 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 3)].sprite = { 1, 7 };
	...
	case 2:
	{
		gui.activeUI[int(pos.x + 3)][int(pos.y + 1)].sprite = { 1, 8 };
	...
	case 3:
	{
		gui.activeUI[int(pos.x + 1)][int(pos.y + 3)].sprite = { 0, 7 };
		gui.activeUI[int(pos.x + 1)][int(pos.y + 4)].sprite = { 6, 7 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 4)].sprite = { 9, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 3)].sprite = { 1, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 4)].sprite = { 7, 7 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 4)].sprite = { 9, 7 };
		gui.activeUI[int(pos.x + 5)][int(pos.y + 3)].sprite = { 2, 7 };
	...
	case 4:
	{
		gui.activeUI[int(pos.x + 2)][int(pos.y + 1)].sprite = { 2, 8 };
	...
	case 5:
	{
		gui.activeUI[int(pos.x + 2)][int(pos.y + 1)].sprite = { 1, 8 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 1)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].sprite = { 6, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 2)].sprite = { 7, 7 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 2)].sprite = { 8, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 3)].sprite = { 0, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 4)].sprite = { 5, 7 };

		gui.activeUI[int(pos.x + 1)][int(pos.y + 2)].sprite = { 1, 0 }; // Connectors
		gui.activeUI[int(pos.x + 1)][int(pos.y + 2)].textCol = 4;
		gui.activeUI[int(pos.x + 5)][int(pos.y + 2)].sprite = { 2, 0 }; // Connectors
	...
	case 6:
	{
		gui.activeUI[int(pos.x + 3)][int(pos.y)].sprite = { 6, 8 };
		gui.activeUI[int(pos.x + 4)][int(pos.y)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 1)].sprite = { 1, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 2)].sprite = { 5, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 3)].sprite = { 0, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 4)].sprite = { 5, 7 };
		...
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].sprite = { 1, 0 }; // Connectors
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].textCol = 4;
		gui.activeUI[int(pos.x + 2)][int(pos.y)].sprite = { 2, 0 }; // Connectors
		gui.activeUI[int(pos.x + 2)][int(pos.y)].textCol = 4;
		break;
	}

	case 7:
	{
		gui.activeUI[int(pos.x + 3)][int(pos.y + 1)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].sprite = { 6, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 2)].sprite = { 9, 7 };
	...
	case 8:
	{
		gui.activeUI[int(pos.x + 4)][int(pos.y)].sprite = { 6, 8 };
		gui.activeUI[int(pos.x + 5)][int(pos.y)].sprite = { 3, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 1)].sprite = { 6, 8 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 1)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].sprite = { 6, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 2)].sprite = { 1, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 3)].sprite = { 0, 7 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 4)].sprite = { 5, 7 };

		gui.activeUI[int(pos.x + 1)][int(pos.y + 2)].sprite = { 1, 0 }; // Connectors
		gui.activeUI[int(pos.x + 1)][int(pos.y + 2)].textCol = 4;
		gui.activeUI[int(pos.x + 2)][int(pos.y + 1)].sprite = { 2, 0 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 1)].textCol = 4;
		gui.activeUI[int(pos.x + 3)][int(pos.y)].sprite = { 3, 0 };
		gui.activeUI[int(pos.x + 3)][int(pos.y)].textCol = 4;
		break;
	}

	case 9:
	{
		gui.activeUI[int(pos.x + 2)][int(pos.y)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 1)].sprite = { 4, 8 };
		gui.activeUI[int(pos.x + 4)][int(pos.y)].sprite = { 3, 8 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 1)].sprite = { 5, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 1)].sprite = { 1, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 2)].sprite = { 5, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 3)].sprite = { 0, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 4)].sprite = { 5, 7 };

		gui.activeUI[int(pos.x + 1)][int(pos.y + 1)].sprite = { 2, 0 }; // Connectors
		gui.activeUI[int(pos.x + 1)][int(pos.y + 1)].textCol = 4;
		gui.activeUI[int(pos.x + 5)][int(pos.y + 1)].sprite = { 3, 0 };
		gui.activeUI[int(pos.x + 5)][int(pos.y + 1)].textCol = 4;
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].sprite = { 1, 0 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].textCol = 4;
		break;
	}
	...
	case 10:
	{
		gui.activeUI[int(pos.x + 2)][int(pos.y)].sprite = { 3, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 1)].sprite = { 5, 7 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].sprite = { 1, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 3)].sprite = { 4, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 3)].sprite = { 0, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 4)].sprite = { 5, 7 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 2)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 3)].sprite = { 5, 8 };

		gui.activeUI[int(pos.x + 1)][int(pos.y + 1)].sprite = { 3, 0 }; // Connectors
		gui.activeUI[int(pos.x + 1)][int(pos.y + 1)].textCol = 4;
		gui.activeUI[int(pos.x + 1)][int(pos.y + 3)].sprite = { 1, 0 };
		gui.activeUI[int(pos.x + 1)][int(pos.y + 3)].textCol = 4;
		gui.activeUI[int(pos.x + 5)][int(pos.y + 3)].sprite = { 2, 0 };
		gui.activeUI[int(pos.x + 5)][int(pos.y + 3)].textCol = 4;
		break;
	}
	...
	case 11:
	{
		...
		gui.activeUI[int(pos.x + 3)][int(pos.y)].sprite = { 3, 8 };
		gui.activeUI[int(pos.x + 4)][int(pos.y)].sprite = { 7, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 1)].sprite = { 1, 8 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 1)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].sprite = { 6, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 2)].sprite = { 7, 7 };
		...
		gui.activeUI[int(pos.x + 1)][int(pos.y)].sprite = { 3, 0 }; // Connectors
		gui.activeUI[int(pos.x + 1)][int(pos.y)].textCol = 4;
		gui.activeUI[int(pos.x + 5)][int(pos.y)].sprite = { 4, 0 };
		gui.activeUI[int(pos.x + 5)][int(pos.y)].textCol = 4;
		gui.activeUI[int(pos.x + 1)][int(pos.y + 2)].sprite = { 1, 0 };
		gui.activeUI[int(pos.x + 1)][int(pos.y + 2)].textCol = 4;
	...
	case 12:
	{
		...
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].sprite = { 6, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 2)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 2)].sprite = { 7, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 3)].sprite = { 0, 7 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 3)].sprite = { 1, 7 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 4)].sprite = { 6, 7 };
	...
	case 14:
	{
		...
		gui.activeUI[int(pos.x + 5)][int(pos.y + 1)].sprite = { 3, 8 };
	...
	case 15:
	{
		gui.activeUI[int(pos.x + 2)][int(pos.y + 1)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 2)].sprite = { 5, 7 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 1)].sprite = { 3, 8 };
	...
	case 16:
	{
		gui.activeUI[int(pos.x + 3)][int(pos.y + 1)].sprite = { 3, 8 };
	...
	case 18:
	{
		gui.activeUI[int(pos.x + 1)][int(pos.y + 1)].sprite = { 2, 8 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 1)].sprite = { 3, 8 };
		gui.activeUI[int(pos.x + 1)][int(pos.y + 2)].sprite = { 6, 7 };
	...
	case 19:
	{
		gui.activeUI[int(pos.x + 0)][int(pos.y + 3)].sprite = { 0, 7 };
		gui.activeUI[int(pos.x + 0)][int(pos.y + 4)].sprite = { 6, 7 };
		gui.activeUI[int(pos.x + 1)][int(pos.y + 4)].sprite = { 9, 7 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 3)].sprite = { 1, 7 };
		gui.activeUI[int(pos.x + 2)][int(pos.y + 4)].sprite = { 9, 7 };
		gui.activeUI[int(pos.x + 3)][int(pos.y + 4)].sprite = { 7, 7 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 3)].sprite = { 2, 7 };
		gui.activeUI[int(pos.x + 4)][int(pos.y + 4)].sprite = { 9, 7 };
		gui.activeUI[int(pos.x + 5)][int(pos.y + 4)].sprite = { 9, 7 };
		gui.activeUI[int(pos.x + 6)][int(pos.y + 3)].sprite = { 3, 7 };
